...
#define PROXIMITY_FILT_RESET_TIME     250     // reset filter if last distance was pushed more than this many ms away
...
private:
    ...
    LowPassFilter<float> _filtered_distance[PROXIMITY_NUM_LAYERS][PROXIMITY_NUM_SECTORS]; // low pass filter
};
