...
protected:
    ...
    public:      
        ...
        void update_boundary(const uint8_t sector, const bool push_to_OA_DB) { update_boundary(sector, PROXIMITY_MIDDLE_STACK, push_to_OA_DB);   }
        void update_boundary(const uint8_t sector, const uint8_t stack, const bool push_to_OA_DB);
