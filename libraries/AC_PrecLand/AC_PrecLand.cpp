...
const AP_Param::GroupInfo AC_PrecLand::var_info[] = {
    ...
    // @Range: 0 10
    // @Increment: 1
    AP_GROUPINFO("RET_MAX", 11, AC_PrecLand, _retry_max, 4),
    ...
    // @Range: 0 20
    // @Units: s
    AP_GROUPINFO("TIMEOUT", 12, AC_PrecLand, _retry_timeout_sec, 4),
    ...
    AP_GROUPINFO("RET_BEHAVE", 13, AC_PrecLand, _retry_behave, 0),
    ...
    // @Range: 0 5
    // @Units: m
    AP_GROUPINFO("ALT_MIN", 14, AC_PrecLand, _sensor_min_alt, 0.75),
    ...
    // @Range: 0 50
    // @Units: m
    AP_GROUPINFO("ALT_MAX", 15, AC_PrecLand, _sensor_max_alt, 8),
    ...
    // @User: Advanced
    AP_GROUPINFO("MOVING", 16, AC_PrecLand, _moving, 0),
...
void AC_PrecLand::check_target_status(float rangefinder_alt_m, bool rangefinder_alt_valid)
{
    if (target_acquired()) {
        ...
        return;
    } else if (_current_target_state == TargetState::TARGET_FOUND ||
