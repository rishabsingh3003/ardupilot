...
void AP_Logger::Write_Proximity(AP_Proximity &proximity)
{
    ...
    AP_Proximity::Proximity_Distance_Array dist_array {}, filt_dist_array {};
    for (uint8_t i = 0; i < proximity.get_layers(); i++) {
        ...
        bool land_detect = proximity.get_land_detected();
