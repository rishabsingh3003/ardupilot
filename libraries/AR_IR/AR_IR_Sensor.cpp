...
// @Description: Analog Pin number to where the first infrared sensor is attached
// @Range: 0 20
AP_GROUPINFO("PIN_1", 1, AR_IR, param._ir_1_pin_num, IR_1_PIN_NUM),

// @Param: IR_PIN_2
// @DisplayName: Infrared Sensor 2 pin number
// @Description: Analog Pin number to where the second infrared sensor is attached
// @Range: 0 20
